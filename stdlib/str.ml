...
(* $Id: str.ml,v 1.1 1999/10/12 16:18:44 pessaux Exp $ *)

type regexp

external compile_regexp: string[`a] <[`b]-> bool[`c] <[`d]->
  regexp[_] = "str_compile_regexp"
external string_match: regexp[`a] <[`b]-> string[`c] <[`d]-> int[`e]
  <[`f]-> bool["false":Pre;"true":Pre;`g] = "str_string_match"
external string_partial_match: regexp[`a] <[`b]-> string[`c] <[`d]->
  int[`e] <[`g]-> bool["false":Pre;"true":Pre;`h] =
  "str_string_partial_match"
external search_forward: regexp[`a] <[`b]-> string[`c] <[`d]->
  int[`e] <[`f]-> int[_] = "str_search_forward"
external search_backward: regexp[`a] <[`b]-> string[`c] <[`d]->
  int[`e] <[`f]-> int[_] = "str_search_backward"
external beginning_group: int[`a] <[`b] -> int[_] = "str_beginning_group"
external end_group: int[`a] <[`b] -> int[_] = "str_end_group"
external replacement_text: string[`a] <[`b]->
  string[`c] <[`d]-> string[_] = "str_replacement_text"
