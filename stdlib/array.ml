...
(* $Id: array.ml,v 1.5 1998/10/19 14:19:27 pessaux Exp $ *)

(* Array operations *)

external length : 'a array[_] <[`a]-> int[_] = "%array_length" ;;
external get: 'a array[_] <[`a]-> int[`b]
              <[__Invalid_argument14(string[array_get:Pre;`c]);`d]->
              'a = "%array_safe_get" ;;
external set: 'a array[_] <[`a]-> int[`b]
              <[__Invalid_argument14(string[array_set:Pre;`c]);`d]->
              'a <[`e]-> unit[() :Pre; `f] = "%array_safe_set" ;;
external unsafe_get: 'a array[_] <[`a]-> int[`b] <[`c]-> 'a
                = "%array_unsafe_get"
external unsafe_set: 'a array[_] <[`a]-> int[`b] <[`c]-> 'a
                     <[`d]-> unit[() :Pre; `e] = "%array_unsafe_set" ;;
external make: int[`a] <[`b]-> 'a <[`c]-> 'a array[_] = "make_vect" ;;
external create: int[`a] <[`b]-> 'a <[`c]-> 'a array[_] = "make_vect" ;;
